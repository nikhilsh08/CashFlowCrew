        ...
        <div className="bg-white rounded-xl shadow-lg p-8 space-y-8">
          <section>
            ...
            <div className="space-y-4 text-gray-600">
              <p>When you enroll in our Mutual Fund Mastery Workshop, we collect:</p>
          ...
          <section>
            ...
            <p className="text-gray-600">
              We do not sell, trade, or rent your personal information to third parties. We may share your information with service providers who assist us in operating our website and delivering our services.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600">
              ...
              Email: privacy@cashflowcrew.in<br />
              Address: 42, Innovation Hub, Cyber City, Gurugram, Haryana 122002
            </p>
          </section>
        </div>
      </div>
