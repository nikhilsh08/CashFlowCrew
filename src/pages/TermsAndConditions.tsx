    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 space-y-8">
          <section>
            <h1 className="text-blue-600 py-5">
            ...
            <div className="space-y-4 text-gray-600">
              <p>
                By purchasing our Mutual Fund Mastery Workshop, you receive:
              </p>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-600">
              ...
              <p>
                are protected by copyright and may not be shared, distributed,
                or resold.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600">
              ...
              account credentials and must notify us immediately of any
              unauthorized access.
            </p>
          </section>
