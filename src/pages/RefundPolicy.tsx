        ...
        <div className="bg-white rounded-xl shadow-lg p-8 space-y-8">
          <section>
            ...
            <div className="space-y-4 text-gray-600">
              <p>We offer a 7-day, no-questions-asked money-back guarantee on our Mutual Fund Mastery Workshop.</p>
              
              <div className="bg-green-50 border border-green-100 rounded-lg p-4 mt-4">
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-6 h-6 text-green-500 flex-shrink-0 mt-0.5" />
                  <div>
                    <h3 className="font-semibold text-green-900 mb-1">100% Money-Back Guarantee</h3>
                    <p className="text-green-700">If you're not satisfied with the course content within 7 days of purchase, we'll provide a full refund.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-600">
              ...
              <ol className="list-decimal pl-5 space-y-2">
                <li>Email refunds@cashflowcrew.in with your purchase details</li>
                <li>Include "Refund Request - [Your Name]" in the subject line</li>
          ...
          <section>
            ...
            <p className="text-gray-600">
              ...
              Email: refunds@cashflowcrew.in<br />
